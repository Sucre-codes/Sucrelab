...
export default function ResearchLabSetupModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center">
      ...
      <div className="relative w-full sm:max-w-lg sm:rounded-lg rounded-t-2xl bg-[var(--color-panel)] border border-[var(--color-border)] shadow-2xl p-5 flex flex-col gap-4 max-h-[90vh] overflow-y-auto">
        <div>
