    ...
    <div className="flex h-full items-center justify-center bg-[var(--color-ink)] p-6">
      <div className="w-full max-w-sm flex flex-col items-center gap-8">
        ...
        <form onSubmit={handleSubmit} className="w-full flex flex-col gap-4">
          <div>
            <h1 className="font-[family-name:var(--font-display)] text-2xl text-center mb-1">Welcome back</h1>
            <p className="text-sm text-[var(--color-muted)] text-center">Log in to your workspace</p>
          </div>
          ...
          <p className="text-center text-sm text-[var(--color-muted)]">
            No account?{" "}
            <Link to="/signup" className="text-[var(--color-teal)] hover:underline">
              Sign up
            </Link>
          </p>
        </form>
